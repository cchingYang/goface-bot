...
taskType 只有三種：
1. "update_file" — 修改現有頁面的某段文字
   需要：url（網址）、original（原文）、replacement（改文）
...
輸出：{"taskType":"update_file","url":"https://goface.me/blog/b29.html","original":"門禁廠商推薦","replacement":"想找高品質"}
